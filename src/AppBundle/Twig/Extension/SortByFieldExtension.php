        ...
        if (!is_array($content)) {
            ...
            @usort($content, function ($a, $b) use ($sort_by, $direction) {
                ...
                if (is_array($a))
                    ...
                    if($a->{'get' . ucfirst($sort_by)}() instanceof  \DateTimeInterface){

                        $a_sort_value = $a->{'get' . ucfirst($sort_by)}()->getTimestamp();
                    }else {
                ...
                if (is_array($b)){
                    ...
                    if($b->{'get' . ucfirst($sort_by)}() instanceof  \DateTimeInterface){

                        $b_sort_value = $b->{'get' . ucfirst($sort_by)}()->getTimestamp();
                    }else {
